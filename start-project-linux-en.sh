...
if ! command -v node &> /dev/null; then
    ...
    echo "For Linux users, you can also use your distribution's package manager, for example:"
    echo "  Debian/Ubuntu: sudo apt update && sudo apt install nodejs npm"
    echo "  Fedora: sudo dnf install nodejs npm"
    echo "  Arch Linux: sudo pacman -S nodejs npm"
    echo "Alternatively, you can get more up-to-date versions from repositories like NodeSource."
